    ...
    function messageSync()
{
    ...
    syncStream.publishMessage({ 
            textare_color:background_color,
            textarea_value:text
        });
    }
    // Write the code here
